...
import { createRating,deleteRating, fetchRatings, updateRating } from './api/ratings.js';
import { createUser, loginUser } from './api/users.js';
import { BASE_URL, CREATE_USER_WORKLOAD,CRUD_PIZZA_RATING_WORKLOAD, LOGIN_USER_WORKLOAD, THRESHOLDS } from './config/config.js';
...
export function setup() {
	...
	group('Users setup operations', () => {
		...
		authToken = loginUser(`${BASE_URL}/api/users/token/login`, USERNAME, PASSWORD);
	});
	return authToken;
}
